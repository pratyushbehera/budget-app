...
const GroupTransactions = ({ group, groupId }) => {
  ...
  return (
    <div className="row-span-2 bg-white dark:bg-gray-900/40 rounded-[2.5rem] shadow-xl shadow-gray-200/50 dark:shadow-none p-8 border border-gray-100 dark:border-gray-800 animate-fade-in flex flex-col h-full">
      ...
      {isLoading ? (
        ...
        <div className="flex-1 flex flex-col items-center justify-center py-12 text-center">
          ...
          <p className="text-lg font-black text-gray-400 tracking-tight">No group transactions yet</p>
                  ...
                  <div className="flex gap-5">
                    ...
                    <div className="space-y-1">
                      <p className="text-lg font-black text-gray-900 dark:text-white tracking-tight leading-tight">
                        {payerName} paid <span className="text-primary-500">₹{tx.amount}</span>
                      </p>
                  ...
                  <div className="mt-6 border-t border-gray-100 dark:border-gray-700 pt-6 animate-slide-in">
                    ...
                    <div className="space-y-3">
                      {tx.splitDetails.map((s) => {
                        ...
                        const percent = ((Number(s.shareAmount) / tx.amount) * 100).toFixed(0);
