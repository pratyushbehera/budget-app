  ...
  return (
    <div className="max-w-7xl mx-auto py-8 sm:py-12 px-4 sm:px-6 lg:px-10 space-y-8 sm:space-y-10 animate-fade-in relative">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 px-2 sm:px-0">
        <PageHeading
          title="Categories"
          subtitle="Organize your transactions with precision"
        />
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b border-gray-100 dark:border-gray-800">
                <th className="px-4 sm:px-10 py-6 sm:py-8 text-[10px] font-black uppercase tracking-[0.2em] text-gray-400">
                  Label
                </th>
                <th className="px-4 sm:px-10 py-6 sm:py-8 text-[10px] font-black uppercase tracking-[0.2em] text-gray-400 text-center">
                  Controls
                </th>
              </tr>
            </thead>
