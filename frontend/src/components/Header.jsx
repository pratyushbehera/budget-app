  ...
  return (
    <header className="flex flex-col items-start gap-3 md:gap-0 justify-between md:flex-row md:items-center">
      ...
      <div className="flex items-center gap-3 justify-between w-full md:w-auto">
        ...
        />
        <button
          className="flex items-center gap-2 bg-indigo-600 text-white px-3 py-2 rounded shadow"
          onClick={exportCSV}
        >
        ...
        {logoutUser && (
          <button
            className="flex items-center gap-2 bg-red-600 text-white px-3 py-2 rounded shadow"
            onClick={logoutUser}
          >
            Logout
          </button>
