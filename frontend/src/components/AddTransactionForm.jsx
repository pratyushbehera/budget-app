      ...
      <form className="mt-3 space-y-2" onSubmit={addTransaction}>
        ...
        <div className="flex justify-end">
          <button
            ...
            className={`inline-flex items-center gap-2 px-3 py-2 rounded ${isFormValid ? "bg-green-600 text-white hover:bg-green-700" : "bg-gray-400 text-white cursor-not-allowed"}`}
          >
